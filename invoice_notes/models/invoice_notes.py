...
class AccountMove(models.Model):
    ...
    invoice_message = fields.Char(compute='_get_inv_message')
    ...
    def _get_inv_message(self):
        for i in self:
            ...
            msg_1 = self.env.company.inv_message_1
            msg_2 = self.env.company.inv_message_2
            ...
            if i.partner_id.country_id:
                ...
                if i.partner_id.country_id.id in eu_country_group.country_ids.ids and \
                        i.partner_shipping_id.country_id.with_context(lang='en_US').name != 'Slovakia' and \
                        i.partner_id.vat:
                    i.invoice_message = msg_1
